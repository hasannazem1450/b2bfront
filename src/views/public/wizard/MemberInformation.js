    ...
    <Fragment>
      <Form onSubmit={handleSubmit(onSubmit)}>
        <div className='content-header'>
          <h5 className='mb-0'>{translate("Member Information")}</h5>
          <small className='text-muted'>{translate("Enter Your Member Information.")}</small>
        </div>
            ...
            <Row>
              <Col md='6'>
                ...
                <Col className='mb-1'>
                  ...
                  <Select options={store.posision} />
                </Col>
                <Col className='mb-1'>
                  <Label for='profilePhoto' className='form-label'>
                  ...
                  <FileUploaderLogo id="personelphoto" title={"100X100"} />
                </Col>
